...
func (h *Header) Parse(b *bytes.Reader, sentBy protocol.Perspective, ver protocol.VersionNumber) (*ExtendedHeader, error) {
	...
	if h.IsLongHeader {
		...
		return h.parseLongHeader(b, sentBy, ver)
	}
...
func (h *Header) parseLongHeader(b *bytes.Reader, sentBy protocol.Perspective, v protocol.VersionNumber) (*ExtendedHeader, error) {
	eh := h.toExtendedHeader()
