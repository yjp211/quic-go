...
func (h *ExtendedHeader) parse(b *bytes.Reader, sentBy protocol.Perspective, v protocol.VersionNumber) (*ExtendedHeader, error) {
	if h.IsLongHeader {
		return h.parseLongHeader(b, sentBy, v)
	}
	return h.parseShortHeader(b, v)
}

func (h *ExtendedHeader) parseLongHeader(b *bytes.Reader, sentBy protocol.Perspective, v protocol.VersionNumber) (*ExtendedHeader, error) {
...
func (h *ExtendedHeader) Write(b *bytes.Buffer, pers protocol.Perspective, ver protocol.VersionNumber) error {
	if h.IsLongHeader {
